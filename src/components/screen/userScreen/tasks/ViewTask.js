...
export default class UserViewTask extends Component {
    constructor(props) {
        super(props);
        this.state = {
            taskModel: {},
                        ...
                        
                        {
                            ...
                            <View
                                ...
                                <View
                                    ...
                                    <TouchableOpacity onPress={() => this.OpenStatus()}
