...
import { GetMonthlyAttendanceDetails } from '../../../../services/api/AttendanceService'
...
export default class DetailScreen extends React.Component {
    ...
    GetAllEmployeeAttendanceDetail = async () =>
    {
        try
        {
            ...
            await GetMonthlyAttendanceDetails(this.props.detailItem.UserId,this.props.year,this.props.month)
                .then(res =>
                {
                    ...
                    <View
                        ...
                        <View
                            ...
                            <Text
                              ...
                              {this.props.detailItem.EmployeeName}
                            </Text>
                        </View>
